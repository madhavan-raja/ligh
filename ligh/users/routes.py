...
from ligh import db, bcrypt
from ligh.models import User, Post
from ligh.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm
from ligh.users.utils import save_profile_picture, send_reset_email
...
def account():
    ...
    if form.validate_on_submit():
        if form.use_default_profile_picture.data:
            current_user.profile_picture = "default.jpg"
        elif form.profile_picture.data:
            profile_picture_filename = save_profile_picture(form.profile_picture.data)
